...
%Uncomment if you want to plot evolution of opinions: (definetley comment
%if you use this function a loop otherwise N figures will pop up). 
...
% 
%  for iter=1:n
%    Legend{iter}=strcat(  num2str(iter) , '(' , num2str(Alpha(iter)) , ')');
%  end
